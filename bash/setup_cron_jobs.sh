...
chmod +x "$PROJECT_ROOT/bash/setup/setup_logging.sh"
chmod +x "$PROJECT_ROOT/bash/view_logs.sh"
chmod +x "$PROJECT_ROOT/bash/logs/view_risk_manager_logs.sh"
chmod +x "$PROJECT_ROOT/bash/logs/view_all_logs.sh"
...
echo "   - View RiskManager logs: ./bash/logs/view_risk_manager_logs.sh"
echo "   - View all logs: ./bash/logs/view_all_logs.sh"
